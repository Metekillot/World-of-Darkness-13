...
#define span_h6(str) ("<span class ='h6'>" + str + "</span>")
#define span_em(str) ("<span class ='em'>" + str + "</span>")
...
#define span_a(str) ("<span class ='a'>" + str + "</span>")
...
#define span_userhelp(str) ("<span class ='userhelp'>" + str + "</span>")
...
#define span_phone(str) ("<span class ='phone'>" + str + "</span>")
#define span_smallphone(str) ("<span class ='smallphone'>" + str + "</span>")
